...
shinyServer(function(input, output,session) {
 ...
 #new edit # Function to clean tweets, Stanton 2013
  ...
  wordcloudentity<-function(entitycleantext)
  {
    ...
    wcloudentity<-wordcloud(cloudFrame$word,cloudFrame$freq,max.words=100, colors=brewer.pal(8,"Dark2"),scale=c(4,0.1), random.order=TRUE)
    print(wcloudentity)
  }
